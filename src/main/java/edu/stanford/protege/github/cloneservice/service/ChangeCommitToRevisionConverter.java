...
public class ChangeCommitToRevisionConverter {
     ...
     * 
     * <p>This method transforms git commit information including metadata and axiom changes
     * into a format suitable for WebProtege's revision system. Each commit is assigned an
     * incrementing revision number to maintain chronological ordering.</p>
     * 
