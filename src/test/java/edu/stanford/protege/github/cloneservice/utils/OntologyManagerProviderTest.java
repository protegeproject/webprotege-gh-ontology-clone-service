...
class OntologyManagerProviderTest {
    ...
    void haveConsistentParserCountAcrossManagerInstances() {
        ...
        assertEquals(parsers1.size(), parsers2.size(), "Both managers should have the same number of parsers");
    ...
    void haveConsistentFactoryCountAcrossManagerInstances() {
        ...
        assertEquals(factories1.size(), factories2.size(), "Both managers should have the same number of factories");
