...
class AxiomChangeTest {
    ...
    void createAxiomChangeWhenAllParametersProvided() {
        var axiomChange = new AxiomChange(AxiomChange.OperationType.ADD, mockAxiom, mockOntologyId);
    ...
    void throwExceptionWhenOperationTypeNull() {
        var exception =
                assertThrows(NullPointerException.class, () -> new AxiomChange(null, mockAxiom, mockOntologyId));
    ...
    void throwExceptionWhenAxiomNull() {
        var exception = assertThrows(
                NullPointerException.class, () -> new AxiomChange(AxiomChange.OperationType.ADD, null, mockOntologyId));
    ...
    void throwExceptionWhenOntologyIdNull() {
        var exception = assertThrows(
                NullPointerException.class, () -> new AxiomChange(AxiomChange.OperationType.ADD, mockAxiom, null));
    ...
    void throwExceptionWhenAddAxiomFactoryMethodNullAxiom() {
        var exception = assertThrows(NullPointerException.class, () -> AxiomChange.addAxiom(null, mockOntologyId));
    ...
    void throwExceptionWhenRemoveAxiomFactoryMethodNullOntologyId() {
        var exception = assertThrows(NullPointerException.class, () -> AxiomChange.removeAxiom(mockAxiom, null));
