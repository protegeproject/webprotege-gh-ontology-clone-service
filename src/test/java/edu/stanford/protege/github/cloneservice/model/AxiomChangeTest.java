...
class AxiomChangeTest {
  ...
  void throwExceptionWhenOperationTypeNull() {
    var exception =
        assertThrows(
            NullPointerException.class, () -> new AxiomChange(null, mockAxiom, mockOntologyId));
  ...
  void throwExceptionWhenAddAxiomFactoryMethodNullAxiom() {
    var exception =
        assertThrows(NullPointerException.class, () -> AxiomChange.addAxiom(null, mockOntologyId));
  ...
  void throwExceptionWhenRemoveAxiomFactoryMethodNullOntologyId() {
    var exception =
        assertThrows(NullPointerException.class, () -> AxiomChange.removeAxiom(mockAxiom, null));
